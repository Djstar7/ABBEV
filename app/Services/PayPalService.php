...
class PayPalService
{
    ...
    {
        // Charger les credentials depuis les configurations
        $this->clientId = Configuration::getValue('paypal_client_id');
        $this->clientSecret = Configuration::getValue('paypal_client_secret');
        $this->mode = Configuration::getValue('paypal_mode', 'sandbox');
                ...
                ->post("{$this->baseUrl}/v2/checkout/orders", [
                    ...
                    'purchase_units' => [
                        [
                            ...
                            'description' => "Abonnement ABBEV - {$amountXaf} FCFA",
                        ],
                    ],
                    'application_context' => [
                        'brand_name' => 'ABBEV',
